...
?>
    ...
    <section id="featured" class="my-5 pb-5">
        <div class="container text-center mt-5 py-5">
            <h3>Our Featured</h3>
            <hr class="mx-auto">
            <p>You can check out our product here</p>
        </div>
    ...
    <section id="banner" class="my-5 py-5">
        <div class="container">
            <h4>BLACK FRIDAY'S SALE</h4>
            <h1>Black Collection <br> UP to 30% OFF</h1>
            <button class="text-uppercase">Buy Now</button>
        </div>
    </section>
    ...
    <section id="office" class="my-5 pb-5">
        <div class="container text-center mt-5 py-5">
            <h3>For Office</h3>
            <hr class="mx-auto">
            <p>You can check out our product here</p>
        ...
        <div class="row mx-auto container-fluid">
            ...
            <?php include('server/get_offices.php'); ?>
            <?php while($row= $offices_products->fetch_assoc()) { ?>
            <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                <img class="img-fluid mb-3" src="assets/imgs/<?php echo $row['product_image']; ?>">
                <h5 class="p-name"><?php echo $row['product_name']; ?></h5>
                <h4 class="p-price">$ <?php echo $row['product_price']; ?></h4>
    ...
    <section id="gaming" class="my-5 pb-5">
        <div class="container text-center mt-5 py-5">
            <h3>Gaming</h3>
            <hr class="mx-auto">
            <p>You can check out our product here</p>
        ...
        <div class="row mx-auto container-fluid">
            ...
            <?php include('server/get_gamings.php'); ?>
            <?php while($row= $gamings_products->fetch_assoc()) { ?>
